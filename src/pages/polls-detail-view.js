                ...
                <section className="container">
                    <div className="row justify-content-center align-items-center">
                        <div className="card col-6 p-0">
                            <div className="card-header text-center p-4">Poll</div>
                            {pollDetail && <>
                                <div className="card-body">
                                    <h5 className="card-title p-1">{pollDetail.questions}</h5>
                                                    ...
                                                    <div className="card-header" id="headingOne">
                                                        <h2 className="mb-0">
                                                            <button className="btn btn-link" type="button" aria-expanded="false"
                                                                onClick={(e) => showAnwsersVote(headingOne)}>{anwser.text}</button>
                                                        </h2>
                                                    </div>
                                                    <div id="collapseOne" className="collapse" ref={headingOne}>
                                                        <div className="card-body">{anwser.votes}</div>
                                                    </div>
                                                </div>
                                            </>))}
                                        {/* <div className="card border-0 m-2">
